...
### [1 AQS 简单介绍](https://snailclimb.gitee.io/javaguide/#/docs/java/Multithread/AQS?id=_1-aqs-简单介绍)
...
### [2 AQS 原理](https://snailclimb.gitee.io/javaguide/#/docs/java/Multithread/AQS?id=_2-aqs-原理)

> 在面试中被问到并发知识的时候，大多都会被问到“请你说一下自己对于 AQS 原理的理解”。下面给大家一个示例供大家参考，面试不是背题，大家一定要加入自己的思想，即使加入不了自己的思想也要保证自己能够通俗的讲出来而不是背出来。

下面大部分内容其实在 AQS 类注释上已经给出了，不过是英语看着比较吃力一点，感兴趣的话可以看看源码。

#### [2.1 AQS 原理概览](https://snailclimb.gitee.io/javaguide/#/docs/java/Multithread/AQS?id=_21-aqs-原理概览)
...
#### [2.2 AQS 对资源的共享方式](https://snailclimb.gitee.io/javaguide/#/docs/java/Multithread/AQS?id=_22-aqs-对资源的共享方式)
...
#### [2.3 AQS 底层使用了模板方法模式](https://snailclimb.gitee.io/javaguide/#/docs/java/Multithread/AQS?id=_23-aqs-底层使用了模板方法模式)
...
#### [5.4 CyclicBarrier 和 CountDownLatch 的区别](https://snailclimb.gitee.io/javaguide/#/docs/java/Multithread/AQS?id=_54-cyclicbarrier-和-countdownlatch-的区别)
