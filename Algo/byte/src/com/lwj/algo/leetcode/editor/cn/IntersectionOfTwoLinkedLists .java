...
class IntersectionOfTwoLinkedLists {
    ...
    public class Solution {
        public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
            //1.hashset法
//            return byHashSet(headA, headB);
            //2.doublePoint
            return doublePoint(headA, headB);
        }

        private ListNode doublePoint(ListNode headA, ListNode headB) {
        ...
        private ListNode byHashSet(ListNode headA, ListNode headB) {
            HashSet<ListNode> headASets = new HashSet<>();
            ListNode p1 = headA;
            ListNode p2 = headB;
            while (p1 != null) {
                headASets.add(p1);
