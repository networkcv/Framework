...
//lists/ 
// 
// Related Topics 哈希表 链表 双指针 👍 532 👎 0
...
class LiangGeLianBiaoDeDiYiGeGongGongJieDianLcof {
    public static void main(String[] args) {
        ...
        Pair<ListNode, ListNode> pair = ListNodeUtils.buildIntersection(123, 423);
        System.out.println(solution.getIntersectionNode(pair.getLeft(), pair.getRight()).val);
    }
