...
//
//<div><div>Related Topics</div><div><li>哈希表</li><li>链表</li><li>双指针</li></div></div><br><div><li>👍 2611</li><li>👎 0</li></div>
class IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        Solution solution = new IntersectionOfTwoLinkedLists().new Solution();
        System.out.println(solution.getIntersectionNode(ListNodeUtils.build(264), ListNodeUtils.build(15)));
    }
