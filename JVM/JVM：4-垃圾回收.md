...
- 缺点：
  ...
  <img src="D:/study/Notes/JavaVirtualMachine/JVMNotes/JVM 垃圾回收.resource/1574823017674.gif" alt="1574823017674" style="zoom:50%;" />
...
[![CMS收集器](D:/study/Notes/JavaVirtualMachine/JVMNotes/JVM 垃圾回收.resource/cms.png)](https://github.com/weolwo/jvm-learn/blob/master/src/resources/images/cms.png)
...
[![img](D:/study/Notes/JavaVirtualMachine/JVMNotes/JVM 垃圾回收.resource/region.png)](https://github.com/weolwo/jvm-learn/blob/master/src/resources/images/region.png)
...
Hotspot认为没有引用的对象是dead的
 ...
 Hotspot将引用分为四种: **强引用Strong**、**软引用Soft**、**弱引用Weak**、 **虚引用Phantom**

- Strong即默认通过Object o=new Object()这种方式赋值的引用

- Soft, Weak, Phantom这三种则都是继承 Reference

在Full GC时会对Reference类型的引用进行特殊处理

- Soft:内存不够时一定会被GC、长期不用也会被GC
- Weak:一定会被GC,当被mark为dead,在ReferenceQueue中通知 
...
- ![](D:\Study\Framework\JVM\img\1581075605(1).jpg)
...
- ![](D:\Study\Framework\JVM\img\1581075971(1).jpg)
...
- 初始标记(CMS initial mark）	
  ...
  ![](D:\Study\Framework\JVM\img\1581303814(1).jpg)
...
- 并发标记(CMS concurrent mark）
  ...
  ![](D:\Study\Framework\JVM\img\1581304052(1).jpg)
...
- Concurrent Preclean	并发的预先清理	
  ...
  ![](D:\Study\Framework\JVM\img\1581304518(1).jpg)

  ![](D:\Study\Framework\JVM\img\1581304596(1).jpg)
...
- 并发清除(CMS concurrent sweep）
  ...
  ![](D:\Study\Framework\JVM\img\1581317909(1).jpg)
...
![](D:\Study\Framework\JVM\img\1581296308(1).jpg)
...
![](D:\Study\Framework\JVM\img\1581393065(1).jpg)
